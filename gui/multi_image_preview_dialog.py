        ...
        with self.concurrency_limiter:
            ...
            try:
                ...
                gen_args = {
                    ...
                    "cfg_rescale_multiplier": gen_params.get("cfg_rescale_multiplier"), "save_to_gallery": gen_params.get("save_to_gallery", False), "cancellation_event": self.cancellation_event
                }
