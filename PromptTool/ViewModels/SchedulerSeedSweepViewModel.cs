...
public sealed partial class SchedulerSeedSweepViewModel : ObservableObject
{
    ...
    [ObservableProperty] private ObservableCollection<SchedulerSeedResultItem> _results = new();
    ...
    public SchedulerSeedSweepViewModel(
    ...
    {
        var seeds = Enumerable.Range(0, Math.Max(1, count))
            .Select(_ => _rng.Next(1, int.MaxValue))
            .ToList();
        var items = seeds
            .Select(seed => new SchedulerSeedResultItem
            {
                Label = $"Seed {seed}",
                IsLoading = true
            })
        ...
        {
            IsGenerating = true;
            StatusText = "Generating seed sweep...";
        });
        ...
        finally
        {
            ...
            {
                IsGenerating = false;
                StatusText = token.IsCancellationRequested ? "Seed sweep cancelled." : "Seed sweep complete.";
    ...
    private void CancelGeneration()
    {
        ...
        StatusText = "Cancelling seed sweep...";
        _cts?.Cancel();
    }
...
public sealed partial class SchedulerSeedResultItem : ObservableObject
{
